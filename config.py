...
{'chain_id': 'constantine-3', 'api': 'https://archway-testnet-rpc.polkachu.com', 'chain_name': 'ARCHWAY', 'exponent': 18, 'denom': 'const', 'full_denom': 'CONST'},
{'chain_id': 'blumbus_111-1', 'api': 'https://blumbus.api.silknodes.io', 'chain_name': 'DYMENSION_BLUMBUS', 'exponent': 18, 'denom': 'adym', 'full_denom': 'DYM'},
...
{'chain_id': 'dorado-1', 'api': 'https://rest-dorado.fetch.ai', 'chain_name': 'FETCHAI', 'exponent': 18, 'denom': 'afet', 'full_denom': 'FET'},
...
{'chain_id': 'narwhal-2', 'api': 'https://migaloo-testnet-rpc.polkachu.com', 'chain_name': 'MIGALOO', 'exponent': 6, 'denom': 'uwhale', 'full_denom': 'WHALE'},
